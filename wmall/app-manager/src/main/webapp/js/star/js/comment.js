...
jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		title_format	: null,
		info_format	: null,
		image	: '../js/star/images/comment/stars.jpg',
		imageAll :'../js/star/images/comment/stars-all.gif',
		defaultTips :true,
		clickTips :true,
		width	: 24,
		height	: 24
	...
	//显示点击提示
	var clickTips= jQuery('<div class="rater-click-tips"><span  style="color:#f60;">点击星星可以评分</span></div>');
