...
function ajaxRegist(){
	...
	$.ajax({
			url:"ajaxAdminComPerAdd.do",//要请求的servlet
			data:{loginName:loginName,idNumber:idNumber,email:email,phone:phone,realName:realName,loginPass:loginPass,area:area,post:post},//给服务器的参数
			type:"POST",
			dataType:"json",
			async:false,
			cache:false,
