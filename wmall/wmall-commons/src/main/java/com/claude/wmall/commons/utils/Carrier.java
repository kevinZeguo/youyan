...
public class Carrier<T> {
	...
	private int pageSize = 20; //每页有几条数据
	...
	private final Map<String,Boolean> privileges = new HashMap<String,Boolean>();
	...
	public Carrier(int currentPage , int pageSize){
	...
	public Carrier(int currentPage, int pageSize, String sidx, String sord) {
		this.currentPage = currentPage;
		this.pageSize = pageSize;
		this.sidx = sidx;
		this.sord = sord;
