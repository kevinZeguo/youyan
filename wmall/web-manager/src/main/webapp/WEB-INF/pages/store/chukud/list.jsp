...
<head>
    ...
    <script src="<%=path%>/scripts/store/chukud/list.js" type="text/javascript"></script>
</head>
<body>
<div>
    <div class="center_top_t">
        ...
        <br>
        <span>部&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;门</span>
        <span><input type="text" name="bumen" id="bumen"></span>
        <span>领&nbsp;&nbsp;料&nbsp;&nbsp;员：</span>
        <span><input type="text" name="lingliaoy" id="lingliaoy"></span>
        <span>审核状态：</span>
