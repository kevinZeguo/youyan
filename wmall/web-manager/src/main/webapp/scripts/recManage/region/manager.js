...
function initGrid() {
	...
	jQuery("#listRegion").jqGrid({
		...
		//$("#listRegion").setGridWidth($(window).width());
	
	//$("#listRegion").setGridWidth("100%");
	
	$("#listRegion").setGridHeight(window.parent.f_getHeight());
...
function initButton() {
	...
	$("#btnQuery").click(function(event) {
		jQuery("#listRegion").setGridParam({
			page : 1
		});
		jQuery("#listRegion").setGridParam({
	...
	$("#btnEdit").click(function(event) {
		var sIDArray = jQuery("#listRegion").jqGrid('getGridParam','selarrrow');
		var arrIDs = new Array();
		for ( var i = 0; i < sIDArray.length; i++) {
			var id = sIDArray[i];
			var rec = jQuery("#listRegion").jqGrid('getRowData', id);
			var vID = rec.id;
	...
	$("#btnStart").click(
			function(event) {
				// 是个数组
				var sIDArray = jQuery("#listRegion").jqGrid('getGridParam',
						'selarrrow');
