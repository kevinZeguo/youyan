...
function initGrid() {
    ...
    jQuery("#listCustomer").jqGrid({
        url : getContextPath("/recManage/customer/list.do"),
...
function initButton() {
    ...
    $("#btnAdd").click(function(event) {
        window.location = getContextPath("/recManage/customer/toadd.do");
    });
    $("#btnEdit").click(function(event) {
        ...
        window.location = getContextPath("/recManage/customer/toadd.do?id=" + uIds);
    });
