...
function ajaxRegist(){
	...
	$.ajax({
			url:"ajaxAdminAdd.do",//要请求的servlet
			data:{loginName:loginName,idNumber:idNumber,email:email,phone:phone,realName:realName,loginPass:loginPass,area:area},//给服务器的参数
			type:"POST",
			dataType:"json",
			async:false,
			cache:false,
